! function(e) {
    ...
    e.exports = {
        addDevice_button: "デバイスの追加",
        addProvider_button: "プロバイダの追加",
        cancel_button: "キャンセル",
        configure_button: "設定",
        contactSupport: "サポートへのお問い合わせ",
        continue_button: "続ける",
        download: "ダウンロード",
        errorPageLinks: '<a href="https://support.rackspace.com/how-to/" target="_blank">サポートネットワークに移動</a>または<a href="{homeLink}">ホームに戻る</a>',
        federationDocumentation: "フェデレーションに関する資料",
        forgotPassword_link: "パスワードを忘れた場合",
        generateCodes: "コードの生成",
        goBackToLogin_link: "ログインに戻る",
        goBack_button: "戻る",
        goToFederation_link: "会社の認証情報を使用してログイン",
        login_button: "ログイン",
        needHelpLoggingIn_link: "ログインのヘルプが必要ですか？",
        resendCode_button: "コードの再送信",
        resetPassword_button: "パスワードのリセット",
        sendCode_button: "コードの送信",
        submit_button: "送信",
        useAnotherLogin_button: "別なログインを使用",
        usePasswordAuthentication: "パスワード認証を使用",
        verifyDevice_button: "デバイスの認証",
        verify_button: "認証"
    }
}, function(e, t) {
    e.exports = {
        "Unknown Error": "不明なエラー",
        "bad gateway": "サーバー接続エラー",
        error: "エラー",
        forbidden: "禁止されています",
        "internal server error": "サーバーの応答エラー",
        mfaAdd_text: "多要素認証認証は、ログイン時に認証済みデバイスからのコードを要求することによってセキュリティを強化します。モバイルアプリまたはSMSテキストメッセージのいずれかを使用して有効化してください。この処理の最後に、ログアウトし、MFAを使用して再度ログインする必要があります。",
        mfaHelp_text: "デバイスを紛失し、復元コードをお持ちでない場合は、アカウントの所有者にワンタイム復元コードをお問い合わせください。",
        mfaVerification_text: "モバイルパスコードアプリケーションにコードを入力してください。",
        "not authorized": "未承認",
        "not found": "見つかりませんでした",
        passwordExpired_text: "アカウント管理者によって設定された、パスワード有効期限の時間制限を超過しました。このフォームを使用して新しいパスワードを設定してください。",
        passwordResetRequestFirst_error: "パスワードを変更する前に、まずパスワードをリセットするEメールをリクエストする必要があります。",
        passwordResetRequested_text1: "ユーザー名が申請され、ユーザーに登録されているメールアドレス宛にEメールが送信されました。Eメールに記されている指示に従い、パスワードをリセットしてください。",
        passwordResetRequested_text2: "すぐにEメールが届かない場合は、<br>サポートの{usPhoneNumber}（国際：{intlPhoneNumber}）までお問い合わせください。",
        passwordResetServerError_error: "パスワードのリセット中にサーバーエラーが発生しました。しばらくしてから再度お試しいただくか、サポートまでお問い合わせください。",
        passwordResetSuccessful_text: "パスワードが正常にリセットされました。以下のログインをクリックして、新しいパスワードでログインしてください。",
        passwordResetTokenInvalid_error: "指定のトークンは無効か有効期限切れです。パスワードをリセットするリンクをリクエストしてください。",
        passwordUpdateSuccessful_text: "パスワードが正常に更新されました。以下のログインをクリックして、新しいパスワードでログインしてください。",
        registrationCodeNotValid_error: "この招待コードは無効です。",
        requestId_label: "リクエストID：{errorRequestId}",
        resetPassword_text: "新しいパスワードの入力、確認を行って、新しいパスワードでログインできるようにしてください。",
        supportPhoneNumbers: "米国内フリーダイヤル：{usPhoneNumber}<br>国際：{intlPhoneNumber}<br>英国：{ukPhoneNumber}",
        "too many requests": "リクエスト数が多すぎます。"
    }
}, function(e, t) {
    e.exports = {
        authenticationName_label: "認証名",
        authenticatorAppPasscode_label: "認証アプリのパスコード",
        confirmNewPassword_label: "新しいパスワードの確認",
        confirmNewPassword_placeholder: "新しいパスワードの確認",
        emailAddress_label: "メールアドレス：",
        firstName_label: "名：",
        idpNameOrEmailAddress_label: "お使いのIDプロバイダの名前またはお客様のメールアドレスを入力してください。",
        idpNameOrEmailAddress_placeholder: "名前またはメールアドレス",
        lastName_label: "姓：",
        mfaCode_placeholder: "MFAコード",
        mobileAuthenticationApp_label: "モバイル認証アプリ（推奨）",
        newPassword_label: "新しいパスワード",
        oldPassword_label: "古いパスワード",
        passcode_label: "パスコード",
        passwordResetMessage_label: "ユーザー名が登録されているメールアドレス宛にパスワードリセット用リンクを送信します。",
        password_placeholder: "パスワード",
        phoneNumber_label: "電話番号：",
        rememberMe_label: "ログイン状態を保存する",
        secretKey_label: "シークレットキー",
        securityAnswer_label: "セキュリティ認証用の回答",
        securityQuestion_label: "セキュリティ認証用の質問",
        smsMessage_label: "SMSメッセージ",
        username_label: "ユーザー名",
        username_placeholder: "ユーザー名"
    }
}, function(e, t) {
    e.exports = {
        accountSwitcher: "このサービスにアクセスするアカウントはどれですか？",
        addMfaDevice: "多要素認証デバイスの追加",
        authenticationDevice: "認証デバイス",
        authenticationType: "認証タイプ",
        contactSupport: "サポートへのお問い合わせ",
        finishAndLogIn: "終了してログイン",
        generateRecoveryCodes: "復元コードの生成",
        idpAdd: "IDプロバイダの追加",
        idpLogin: "マイ組織からログイン",
        login: "ログイン",
        mfaHelp: "多要素認証のヘルプ",
        mfaRequired: "多要素認証が必要です",
        mfaVerification: "MFA認証",
        needHelp: "ヘルプが必要ですか？",
        passwordExpired: "パスワードが期限切れです",
        passwordRequirements: " パスワードの要件",
        passwordResetError: "パスワードリセットエラー",
        passwordSuccessfullyReset: "パスワードが正常にリセットされました",
        passwordSuccessfullyUpdated: "パスワードが正常に更新されました",
        registerYourAccount: "アカウントの登録",
        resetPassword: "パスワードのリセット",
        selectLogin: "ログインの選択",
        updateYourPassword: "パスワードの更新",
        userRegistrationError: "ユーザー登録エラー",
        verifyDevice: "デバイスの認証"
    }
}, function(e, t) {
    e.exports = {
        addOtpDevice_text1: "お使いの電話の他の認証アプリと区別できるように、この認証アプリに名前を付けてください。",
        addOtpDevice_text2: "アプリを設定して開き、PINを生成して、デバイスを認証してください。",
        addSmsDevice_text1: "テキストメッセージ認証では、キャリアによっては費用が発生する場合があります。",
        addSmsDevice_text2: "SMSテキストメッセージの受信が可能な電話番号を入力してください。この電話番号にアクセスできることを確認するため、コードを送信します。",
        finishAndLogIn_button: "終了してログイン",
        finish_text: "登録を完了するには、多要素認証でログインしてください。",
        generateCodes_text: "通常どおりに認証を完了できない場合は、復元コードを使用してログインできます。復元コードの使用後は、同じ復元コードを再度使用することはできません。",
        setupDevice_text: "アカウント管理者が、ログイン時のセキュリティを強化するためにアカウント全体の多要素認証を有効にしました。多要素認証の設定が必要です。",
        verifyOtpDevice_text1: "デバイスを認証するには、モバイルアプリを開き、携帯電話のカメラを使用してバーコードをスキャンしてください。別な方法として、以下のシークレットキーを入力することもできます。この手順を完了する前にアプリを設定する必要があります。",
        verifyOtpDevice_text2: "バーコードのスキャン後、アプリによって生成された認証コードを入力してください。",
        verifySmsDevice_text: "携帯電話に送信されたパスコードを入力して、デバイスを認証してください。"
    }
}, function(e, t) {
    e.exports = {
        idpNameRequired: "メールアドレスまたはIDプロバイダ名が必須です",
        idpNotFound: "指定された名前ではIDプロバイダは見つかりませんでした",
        invalidPasscode: "無効なパスコード",
        ipAddress: "フィールドにはIPv4アドレスを入力してください",
        loginError: "ログインエラー",
        maxLength: "フィールドには最大{chars}文字を入力してください",
        mfaVerificationError: "MFA認証エラー",
        minLength: "{chars, plural, other {フィールドには{chars,number}文字以上を入力してください}}",
        minLength_short: "{chars, plural, other {{chars,number}文字以上}}",
        passwordContainsLowercase: "パスワードには小文字を含めてください",
        passwordContainsLowercase_short: "小文字1文字",
        passwordContainsNumber: "パスワードには数字を含めてください",
        passwordContainsNumber_short: "数字1文字",
        passwordContainsUppercase: "パスワードには大文字を含めてください",
        passwordContainsUppercase_short: "大文字1文字",
        passwordMinLength: "{chars, plural, other {新しいパスワードには{chars,number}文字以上を入力してください}}",
        passwordNoWhitespace: "パスワードの先頭または末尾に空白を含めることはできません",
        passwordsMustMatch: "確認するパスワードと新しいパスワードを一致させる必要があります",
        passwordsMustMatch_short: "パスワードを一致させる必要があります",
        phoneNumberFormat: "フィールドには有効な電話番号を入力してください",
        required: "フィールドは必須です",
        url: "フィールドには有効なURLを設定してください",
        validatorGeneric: "検証処理 {validatorName} が問題を検知しました"
    }
}, function(e, t, r) {
    "use strict";
    var n = r(1);
